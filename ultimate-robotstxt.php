...
Version: 1.0
Plugin URI: https://totalcleaningmelbourne.com.au/
Description: Automatically creates a robots.txt file for your site.
...
/*
Copyright 2017 Total Cleaning Melbourne

Originally developed by Total Cleaning Melbourne
...
class web_robots {
	...
	function deactivate() {
		...
		// i.e. delete_option('web_robots');
		$options = $this->get_options();
		if ( $options['remove_settings'] )
			delete_option( 'web_robots' );
	}// end function
	
	function settings_link($links) {
		$settings_link = '<a href="options-general.php?page=ultimate-robotstxt/admin.php">Settings</a>';
	...
	function do_robots() {
		...
		if ( is_robots() ) {
			...
			$output = "# This robots.txt file was created by the Ultimate Robots.txt\n";
	...
	function get_options() {
		$options = get_option( 'web_robotstxt' );
		if ( !is_array( $options ) )
	...
	function set_defaults() {
		...
		update_option( 'web_robotstxt', $options );
		return $options;
	}// end function

}// end class
$web_robotstxt = new web_robots;
